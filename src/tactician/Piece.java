...
public enum Piece {
	 ...
	 * literature. It is simply the capital first letter of the name of the piece, except the
	 * knight has initial 'N' so that it is not confused with the king.
	...
	/**
	 * Given an initial, returns the type of piece it corresponds to. See {@link #initial()} for
	 * more details.
