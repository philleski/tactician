...
public class Bitboard {
  ...
  /**
   * Reflects the bitboard along the horizontal axis dividing the two players (the line between the
   * fourth and fifth ranks, 1-indexed). For example if the original bitboard has occupied squares
   * c2 and d5, the resulting bitboard will have occupied squares c7 and d4.
   * 
  ...
  /**
   * Returns a modified bitboard which has squares occupied by the original AND by the mask. See
   * the class definition for how the mask's data is represented.
   * 
   * @param mask a 64-bit long representing another bitboard with which to intersect the original
   * @return a bitboard containing all the original occupied squares that are
   *         also occupied by the mask
   */
  ...
  /**
   * Returns a modified bitboard which has squares occupied by the original OR by the mask. See the
   * class definition for how the mask's data is represented.
   * 
  ...
  /**
   * Updates the bitboard to remove all the squares occupied by the mask. For example if this has
   * occupied squares e7 and h2, and the mask has occupied squares h2 and c5, then this will end up
   * having only e7 occupied.
   * 
  ...
  /**
   * Updates the bitboard to remove all the squares occupied by the other bitboard. For example if
   * this has occupied squares e7 and h2, and other has occupied squares h2 and c5, then this will
  ...
  /**
   * Updates the bitboard to include all the squares occupied by the mask. For example if this has
   * occupied squares e7 and h2, and the mask has occupied squares h2 and c5, then this will end up
   * having e7, h2, and c5 occupied.
   * 
  ...
  /**
   * Updates the bitboard to include all the squares occupied by the other bitboard. For example if
   * this has occupied squares e7 and h2, and the mask has occupied squares h2 and c5, then this
   * will end up having e7, h2, and c5 occupied.
   * 
  ...
  /**
   * Returns the number of empty squares starting from a1. For example if this has occupied squares
   * c2 and h5, then since a1-h1, a2, and b2 are empty, the result would be 10. If a1 is occupied
   * the result is 0.
   * 
  ...
  /**
   * Sets the occupied squares based on a 64-bit long representation. See the class definition for
   * a description of the long representation.
   * 
