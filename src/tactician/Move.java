 ...
 * a1 square, or the bottom left square from white's perspective. The index increments as we move
 * to the right from white's perspective, with 1 being the b1 square, 2 being the c1 square, and so
 * on. Once we reach the h-file the next square is one row up on the a-file. So an index of 8
...
public class Move {
  ...
  /**
   * Outputs the string representation of the move containing the source square, destination square,
   * and promotion piece if any. For example this may be "a7a5" or "e7e8Q". Note that algebraic
   * notation, the standard chess notation for representing moves, is impossible without reference
   * to a board.
   */
  @Override
  ...
  /**
   * The index of the source square from 0-63. See the class definition for how the indexing works.
   */
  public int source;
