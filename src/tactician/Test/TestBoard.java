...
public class TestBoard {
  /**
   * Tests the full move counter when white is the last to move. The full move counter should start
   * at 1 and increment every time black moves.
   */
  @Test
  ...
  /**
   * Tests the full move counter when black is the last to move. The full move counter should start
   * at 1 and increment every time black moves.
   */
  @Test
  ...
  /**
   * Tests that when a board is initialized from a FEN string, the full move counter is copied over
   * correctly.
   */
  @Test
