...
/**
 * <p>This class represents one of the 64 squares on the chessboard. A chessboard has 8 ranks, or
...
public class Square {
	/**
	 * Initializes a square based on its two-character name. The name must be the file, lowercase
	 * a-h, followed by the rank, 1-8.
	...
	/**
	 * Returns the 64-bit long mask corresponding to the {@link Bitboard} with only the current
	 * square occupied.
	...
	/**
	 * Returns the name of the file corresponding to the square, 'a'-'h'. See the class definition
	 * for more details.
	...
	/**
	 * Returns the name of the rank corresponding to the square, '1'-'8'. See the class definition
	 * for more details.
