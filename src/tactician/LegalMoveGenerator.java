 ...
 * 
 * <p>
 * A key concept is the use of attack squares, which are masks describing where a piece can move
 ...
 * 
 * <p>
 * Another set of pre-generated variables relates to castling. The rules of chess state that the
